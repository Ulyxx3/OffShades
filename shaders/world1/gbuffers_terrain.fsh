...
/*
================================================================================
  OffShades — world1/gbuffers_terrain.fsh
  End terrain fragment shader. Writes gbuffer data with full skylight = 1.0
  (The End has ambient purple sky everywhere, no directional sun).
================================================================================
*/
#define WORLD_END
...
void main() {
    ...
    // Skylight = 1.0 everywhere in The End (no direct sun, ambient from End sky)
    float skylight   = 1.0;
